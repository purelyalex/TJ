...
const loveQuotes = [
  ...
  },
  {
    ...
    story:
      "I used to think love meant sacrificing everything for someone else. But I learned that healthy love starts with a healthy relationship with yourself. Self-love isn't selfish; it's necessary, and greatness requires internal toughness",
    image: "20.jpg",
    likes: 72,
  },
  {
...
const testimonials = [
  {
    name: "Ian Mutuli",
    role: "Fellow Student",
    content: "Working with TJ on group projects has been amazing.",
  },
]
...
function updateSectionContent() {
  ...
  // Update about content - only show for portfolio
...
function updateAboutVisibility() {
  ...
  const aboutNavDesktop = document.getElementById("about-nav")
  const aboutNavMobile = document.getElementById("about-nav-mobile")
  const footerAbout = document.getElementById("footer-about")

  if (currentSection === "portfolio") {
    aboutSection.style.display = "block"
    if (aboutNavDesktop) aboutNavDesktop.style.display = "block"
    if (aboutNavMobile) aboutNavMobile.style.display = "block"
    if (footerAbout) footerAbout.style.display = "block"
  } else {
    aboutSection.style.display = "none"
    if (aboutNavDesktop) aboutNavDesktop.style.display = "none"
    if (aboutNavMobile) aboutNavMobile.style.display = "none"
